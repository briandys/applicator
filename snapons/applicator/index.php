...
if ( ! function_exists( 'apl_snapons_applicator_func_styles' ) ) {
    function apl_snapons_applicator_func_styles() {
        ...
        wp_enqueue_style( 'apl-snapons-applicator-style', get_theme_file_uri() . '/snapons/applicator/assets/applicator.css', array(), '22.4', 'all' );
...
if ( ! function_exists( 'apl_snapons_applicator_scripts' ) ) {
    function apl_snapons_applicator_scripts() {
        ...
        wp_enqueue_script( 'apl-snapons-applicator-script-global', get_theme_file_uri( '/snapons/applicator/assets/applicator.js' ), array( 'jquery' ), '20.9', true );
        ...
        // Main Menu
        $applicator_l10n['mainMenuShowL'] = __( 'Show Menu', $GLOBALS['apl_textdomain'] );
        $applicator_l10n['mainMenuHideL'] = __( 'Hide Menu', $GLOBALS['apl_textdomain'] );
        ...
        // Main Search
        $applicator_l10n['mainSearchShowL'] = __( 'Show Search', $GLOBALS['apl_textdomain'] );
        $applicator_l10n['mainSearchHideL'] = __( 'Hide Search', $GLOBALS['apl_textdomain'] );
        ...
        // Sub-Navigation
        $applicator_l10n['subNavTogBtnShowL']    = __( 'Show Sub-Nav', $GLOBALS['apl_textdomain'] );
		$applicator_l10n['subNavTogBtnHideL']    = __( 'Hide Sub-Nav', $GLOBALS['apl_textdomain'] );
