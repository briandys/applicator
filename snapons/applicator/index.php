...
if ( ! function_exists( 'applicator_snapons_applicator_styles' ) ) :
    function applicator_snapons_applicator_styles() {
        ...
        wp_enqueue_style( 'applicator-snapons-applicator-style', get_theme_file_uri() . '/snapons/applicator/assets/css/default.css', array(), '2.1', 'all' );
...
if ( ! function_exists( 'applicator_snapons_applicator_scripts' ) ) :
    function applicator_snapons_applicator_scripts() {
        ...
        wp_enqueue_script( 'applicator-snapons-applicator-script-global', get_theme_file_uri( '/snapons/applicator/assets/js/default.js' ), array( 'jquery' ), '3.1', true );
