...
if ( ! function_exists( 'apl_snapons_applicator_func_styles' ) ) {
    function apl_snapons_applicator_func_styles() {
        ...
        wp_enqueue_style( 'apl-snapons-applicator-style', get_theme_file_uri() . '/snapons/applicator/assets/applicator.css', array(), '23.4', 'all' );
...
if ( ! function_exists( 'apl_snapons_applicator_scripts' ) ) {
    function apl_snapons_applicator_scripts() {
        ...
        wp_enqueue_script( 'apl-snapons-applicator-script-global', get_theme_file_uri( '/snapons/applicator/assets/applicator.js' ), array( 'jquery' ), '21.0', true );
