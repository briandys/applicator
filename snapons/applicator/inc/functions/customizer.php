...
function applicator_customize_preview_js() {
...
add_action( 'customize_preview_init', 'applicator_customize_preview_js' );


// Load dynamic logic for the customizer controls area.
function applicator_panels_js() {
...
add_action( 'customize_controls_enqueue_scripts', 'applicator_panels_js' );
