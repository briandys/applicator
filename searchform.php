...
<div class="cp search" data-name="Search">
    <div class="search--cr">
                ...
                <div class="item fs-item search-term--fs-item">
                    <div class="search-term--fs-item--cr">
                        <label class="label search-term--label" for="<?php echo $unique_id; ?>">
                            <span class="label-l"><?php esc_html_e( 'Search for:', 'applicator' ); ?></span>
                        </label>
                    ...
                    <div class="grp form-axn--grp">
                        ...
                        <div class="item form-axn-item search-form--axns--form-axn-item">
                            <div class="btn search-form-reset--btn">
                                <button class="b search-form-reset--b" type="reset">
                                    <span><?php esc_html_e( 'Reset', 'applicator' ); ?></span>
                                </button>
                            </div>
                        </div>
                    </div>
