...
* Comments Actions Snippet
    ...
    ** Comment Creation Ability
        ...
        *** Comment Creation Enabled
            ...
            **** Add Comment Action (obj)
                
                • Add Comment
        
        *** Comment Creation Disabled
        
            **** Comment Creation Disabled Note (obj)
...
if ( ! function_exists( 'applicator_func_comments_actions_snippet' ) ) {
    function applicator_func_comments_actions_snippet() {
        ...
        /* First if Comments Count Object */
        ...
        // Status: Disabled
            ...
            // Content
            $comments_ability_status = applicator_html_obj( array (
                'type'      => 'o',
...
if ( is_singular() ) {
                ...
                if ( ! is_user_logged_in() && get_option( 'comment_registration' ) ) {
                    ...
                    $add_comment_axn_a_href = esc_url( get_permalink() ) . '#comment'$comment_hash;
