...
$next_coms_navi_a_l_mu = '<span class="a_l next-coms-navi---a_l" title="%3$s"><span class="word next-coms-navi--next---word">%1$s</span> <span class="word next-coms-navi--comments---word">%2$s</span></span>';
...
$prev_coms_navi_a_l_mu = '<span class="a_l prev-coms-navi---a_l" title="%3$s"><span class="word prev-coms-navi--next---word">%1$s</span> <span class="word prev-coms-navi--comments---word">%2$s</span></span>';
